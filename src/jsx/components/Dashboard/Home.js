				...
				<div className="col-xl-12">
					<div className="row">
										...
										<div className="card-body">
											<div className="booking-status d-flex align-items-center">
												...
												<div className="ms-4">
													...
													<p className="mb-0">Confirmations</p>
												</div>
											</div>
										</div>
									</div>
								...
								<div className="col-xl-6">
									<div className="card">
										<div className="card-header border-0 pb-0">
											<h4 className="fs-20">Recent Releases Schedule</h4>
										</div>
										<RecentBooking />
									</div>
								</div>
									...
									<div className="row">
											...
											<div className="card bg-secondary">
												<div className="card-body">
													<div className="d-flex align-items-end pb-4 justify-content-between">
														<span className="fs-14 font-w500 text-white">Available Release Today</span>
										...
										<div className="col-xl-6 col-sm-6">
											<div className="card bg-secondary">
												<div className="card-body">
													<div className="d-flex align-items-end pb-4 justify-content-between">
														<span className="fs-14 font-w500 text-white">Requests Today</span>
													...
													<div className="row">
														...
														<div className="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
															<div className="text-center">
																...
																<span className="fs-16">Total Users</span>
															</div>
														</div>
														<div className="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
															<div className="text-center">
																<h3 className="fs-28 font-w600">992</h3>
																<span className="fs-16">Total Requests</span>
															</div>
														</div>
														<div className="col-xl-3 col-sm-3 col-6 mb-4 col-xxl-6">
															<div className="text-center">
						...
						<div className="col-xl-12">
							<div className="card">
								<div className="card-header border-0 pb-0">
									<h4 className="fs-20">Latest Review by Users</h4>
								</div>
